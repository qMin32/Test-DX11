...
void CPythonNetworkStream::RegisterGameHandlers()
{
	...
	h[GC::WARP_LOCAL]             = { &CPythonNetworkStream::RecvWarpLocalPacket,           sizeof(TPacketGCWarpLocal),                  false };
#endif
...
#ifdef ENABLE_SASH_SYSTEM
	h[GC::ACCE]                   = { &CPythonNetworkStream::RecvAccePacket,               sizeof(TPacketAcce),                         false };
#endif
}
