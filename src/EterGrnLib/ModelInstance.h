...
class CGrannyModelInstance : public CGraphicCollisionObject
{
	...
	public:
		...
		void	SetMainModelPointer(CGrannyModel* pkModel, VBufferPtr pkSharedDefromableVertexBuffer);
		void	SetLinkedModelPointer(CGrannyModel* pkModel, VBufferPtr pkSharedDefromableVertexBuffer, CGrannyModelInstance** ppkSkeletonInst);
	...
	protected:
		...
		void	__SetSharedDeformableVertexBuffer(VBufferPtr pkSharedDeformableVertexBuffer);
		
		VBufferPtr GetDeformableVertexBuffer();
	...
	protected:
		...
		VBufferPtr						m_kLocalDeformableVertexBuffer;
