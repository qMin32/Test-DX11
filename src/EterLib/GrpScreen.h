...
public:
	...
	void RenderD3DXMesh(LPD3DXMESH lpMesh, const D3DXMATRIX * c_pmatWorld, float fx, float fy, float fz, float fRadius, D3D11_FILL_MODE D3D11_FILL_MODE);
	void RenderSphere(const D3DXMATRIX * c_pmatWorld, float fx, float fy, float fz, float fRadius, D3D11_FILL_MODE D3D11_FILL_MODE = D3D11_FILL_SOLID);
	void RenderCylinder(const D3DXMATRIX * c_pmatWorld, float fx, float fy, float fz, float fRadius, float fLength, D3D11_FILL_MODE D3D11_FILL_MODE = D3D11_FILL_SOLID);
